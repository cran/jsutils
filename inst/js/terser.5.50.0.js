(() => {
  ...
  // inst/bundle/node_modules/@jridgewell/resolve-uri/dist/resolve-uri.umd.js
  ...
  // inst/bundle/node_modules/terser/lib/utils/index.js
  ...
  // inst/bundle/node_modules/terser/lib/unicode.js
  var UNICODE_NARROW = {
  ...
  function get_full_char_code(str, pos) {
    ...
    if (is_surrogate_pair_head(char_code)) {
      return 65536 + (char_code - 55296 << 10) + str.charCodeAt(pos + 1) - 56320;
    }
    return char_code;
  }
  ...
  // inst/bundle/node_modules/terser/lib/parse.js
  var LATEST_RAW = "";
...
`);
    ...
    function next_token(force_regexp) {
      ...
      for (;; ) {
        ...
        if (OPERATOR_CHARS.has(ch))
          return read_operator();
        if (code == 92 || is_identifier_start_broad(ch))
          return read_word();
        if (code == 35)
    ...
    next_token.typescript_is_type_parameters_before_call = () => {
      const stack = [">"];
      const peek2 = () => get_full_char(S.text, i + 1);
      const next2 = () => get_full_char(S.text, ++i);
      let i = S.pos;
      for (;stack.length; i++) {
...
`);
        ...
        if (ch === "`" || ch === "}" && stack[stack.length - 1] === "${" && stack.pop()) {
          do {
            ch = next2();
            if (ch === "$" && peek2() === "{") {
              next2();
      ...
      while (WHITESPACE_CHARS.has(get_full_char(S.text, i)))
        i++;
  ...
  function parse($TEXT, options) {
    ...
    function vardefs(no_in, kind) {
      ...
      for (;; ) {
        ...
        var start = S.token;
        var name = is("punc", "{") || is("punc", "[") ? binding_element(undefined, sym_type) : as_symbol(sym_type);
        if (name.name == "import")
          croak("Unexpected token: import");
        if (is("punc", ":")) {
          typescript_type_annotation();
        }
        var value = is("operator", "=") ? (next(), expression(false, no_in)) : null;
    ...
    function object_or_class_property(name, start, is_class) {
      ...
      const is_not_method_start = () => !is("punc", "(") && !is("punc", ",") && !is("punc", "}") && !is("punc", ";") && !is("operator", "=") && !is_private;
      var is_async = false;
      var is_static = false;
      var is_generator = false;
      var accessor_type = null;
      if (name === typescript_ellide)
        return name;
    ...
    function import_statement() {
      ...
      if (is("name", "type") && typescript_import_type_statement()) {
    ...
    function map_names(is_import) {
      ...
      if (is("punc", "{")) {
        ...
        names = [];
        while (!is("punc", "}")) {
          if (is("name", "type") && !(is_token(peek(), "name", "as") || is_token(peek(), "punc", ",") || is_token(peek(), "punc", "}")) && typescript_import_named_type()) {} else {
    ...
    function typescript_type_parameters() {
      if (!options.experimental_typescript)
        return;
    ...
    function typescript_import_type_statement() {
      if (!options.experimental_typescript)
        return;
      if (is_token(peek(), "name", "from") || is_token(peek(), "punc", ",")) {
        return false;
      }
      expect_token("name", "type");
      if (!is("punc", "{")) {
    ...
    function typescript_maybe_annotation() {
      if (!options.experimental_typescript)
        return;
      if (is("operator", "?") && is_token(peek(), "punc", ":") && next() || is("punc", ":")) {
        typescript_type_annotation();
        return true;
      }
      return false;
    ...
    function _ts_object_body() {
      const is_method_key = (token) => is_token(token, "name") || is_token(token, "num") || is_token(token, "string") || is_token(token, "operator", "new");
      expect_token("punc", "{");
      _ts_commas_or_semicolons("punc", "}", () => {
        if (is("name", "readonly") && (is_method_key(peek()) || is_token(peek(), "template_head") || is_token(peek(), "punc", "["))) {
          next();
        }
  ...
  // inst/bundle/node_modules/terser/lib/ast.js
  ...
  var AST_DefinitionsLike = DEFNODE("DefinitionsLike", "definitions", function AST_DefinitionsLike2(props) {
    if (props) {
  ...
  var AST_Definitions = DEFNODE("Definitions", null, function AST_Definitions2(props) {
    if (props) {
      this.definitions = props.definitions;
      this.start = props.start;
      this.end = props.end;
  ...
  var AST_Using = DEFNODE("Using", "await", function AST_Using2(props) {
    if (props) {
      this.await = props.await;
      this.definitions = props.definitions;
      this.start = props.start;
  ...
  var AST_VarDefLike = DEFNODE("VarDefLike", "name value", function AST_VarDefLike2(props) {
    if (props) {
      this.name = props.name;
      this.value = props.value;
      this.start = props.start;
  ...
  var AST_VarDef = DEFNODE("VarDef", null, function AST_VarDef2(props) {
    if (props) {
      this.name = props.name;
      this.value = props.value;
      this.start = props.start;
  ...
  var AST_UsingDef = DEFNODE("UsingDef", null, function AST_UsingDef2(props) {
    if (props) {
      this.name = props.name;
      this.value = props.value;
      this.start = props.start;
  ...
  var AST_Import = DEFNODE("Import", "phase imported_name imported_names module_name attributes", function AST_Import2(props) {
    if (props) {
  ...
  var AST_DynamicImport = DEFNODE("DynamicImport", "phase args", function AST_DynamicImport2(props) {
    if (props) {
      this.phase = props.phase;
  ...
  var AST_SymbolUsing = DEFNODE("SymbolUsing", null, function AST_SymbolUsing2(props) {
    if (props) {
      this.init = props.init;
      this.scope = props.scope;
      this.name = props.name;
  ...
  // inst/bundle/node_modules/terser/lib/transform.js
  ...
  // inst/bundle/node_modules/terser/lib/mozilla-ast.js
  (function() {
  ...
  // inst/bundle/node_modules/terser/lib/utils/first_in_statement.js
  ...
  // inst/bundle/node_modules/terser/lib/output.js
  ...
  function OutputStream(options) {
    ...
    var ident_to_utf8 = options.ascii_only || !re_high_identifier ? to_utf8 : function(str) {
      if (re_high_identifier.test(str)) {
        ...
        var escaped = char;
        if (is_identifier_start_broad(char) && !is_identifier_start(char)) {
          const code_point = char.codePointAt(0);
          escaped = code_point <= 65535 ? `\\u${code_point.toString(16).padStart(4, "0")}` : `\\u{${code_point.toString(16)}}`;
        }
        for (var i = char.length;i < str.length; i += char.length) {
          char = get_full_char(str, i);
          if (is_identifier_char_broad(char) && !is_identifier_char(char)) {
            const code_point = char.codePointAt(0);
            escaped += code_point <= 65535 ? `\\u${code_point.toString(16).padStart(4, "0")}` : `\\u{${code_point.toString(16)}}`;
          } else {
            escaped += char;
...
`);
      ...
      if (might_need_space) {
        if (is_identifier_char_broad(prev) && (is_identifier_char_broad(ch) || ch == "\\") || ch == "/" && ch == prev || (ch == "+" || ch == "-") && ch == last) {
          OUTPUT.append(" ");
          current_col++;
          current_pos++;
        }
...
`);
  ...
  (function() {
    ...
    DEFPRINT(AST_DynamicImport, function(self2, output) {
      if (self2.phase)
        output.print("import." + self2.phase);
      else
        output.print("import");
      output.with_parens(function() {
        self2.args.forEach(function(arg, i) {
          if (i)
            output.comma();
          arg.print(output);
        });
  ...
  // inst/bundle/node_modules/terser/lib/equivalent-to.js
  ...
  AST_Import.prototype.shallow_cmp = function(other) {
    return (this.imported_name || null) === (other.imported_name || null) && (this.imported_names || null) === (other.imported_names || null) && (this.attributes || null) === (other.attributes || null) && (this.phase || null) === (other.phase || null);
  };
  ...
  AST_Dot.prototype.shallow_cmp = function(other) {
    return this.property === other.property && !!this.quote === !!other.quote;
  };
  ...
  // inst/bundle/node_modules/terser/lib/scope.js
  ...
  AST_Toplevel.DEFMETHOD("mangle_names", function(options) {
    ...
    var tw = new TreeWalker(function(node, descend) {
      ...
      if (function_defs && node instanceof AST_VarDef && node.name instanceof AST_Symbol && node.value instanceof AST_Lambda && !node.value.name && keep_name(options.keep_fnames, node.name.name)) {
  ...
  // inst/bundle/node_modules/terser/lib/size.js
  ...
  // inst/bundle/node_modules/terser/lib/compress/compressor-flags.js
  var UNUSED = 1;
  var TRUTHY = 2;
  var FALSY = 4;
  var UNDEFINED = 8;
  ...
  // inst/bundle/node_modules/terser/lib/compress/common.js
  ...
  // inst/bundle/node_modules/terser/lib/compress/native-objects.js
  var make_nested_lookup = (feature_callback) => (compressor) => {
  ...
  var make_lookup = (feature_callback) => (compressor) => {
    const obj = feature_callback(feature_variables(compressor));
  ...
  var pure_access_globals = make_lookup(({ sloppy, es }) => [
    "Array",
    "Boolean",
    "clearInterval",
    "clearTimeout",
  ...
  var is_pure_native_fn = make_lookup(({ sloppy, es }) => [
  ...
  var arg1_is_iterable = new Set([
    "Map",
    "Set",
    "WeakMap",
    "WeakSet"
  ]);
  var arg1_is_range_or_iterable = new Set([
    "ArrayBuffer",
    "Float32Array",
    "Float64Array",
    "Int16Array",
  ...
  var lone_arg_is_range = new Set(["Array"]);
  var object_methods = [
    "constructor",
    "toString",
    "valueOf"
  ];
  var is_pure_native_method = make_nested_lookup(({ sloppy, es }) => ({
    Array: [
      es >= 2022 && "at",
      es >= 2019 && "flat",
      es >= 2016 && "includes",
  ...
  var is_pure_native_static_fn = make_nested_lookup(({ sloppy, es }) => ({
    Array: [
      "isArray",
      es >= 2015 && "of"
    ],
  ...
  var is_pure_native_static_property = make_nested_lookup(({ sloppy, es }) => ({
    Math: [
      "E",
      "LN10",
      "LN2",
  ...
  var re_uppercase_first_letter = /^[A-Z]/;
  function is_pure_builtin_call(compressor, call) {
    ...
    if (is_undeclared_ref(exp)) {
      ...
      exp = exp.expression;
      if (is_undeclared_ref(exp)) {
        if (exp.name === "globalThis" && compressor.option("builtins_ecma") >= 2020) {
          builtin = method;
          method = "";
        } else {
          builtin = exp.name;
        ...
        if (is_undeclared_ref(exp.expression) && exp.expression.name === "globalThis" && compressor.option("builtins_ecma") >= 2020) {
    ...
    if (!method) {
      if (compressor.is_pure_native_fn(builtin)) {
        ...
        const should_be_new = re_uppercase_first_letter.test(builtin);
        if (is_new !== should_be_new)
          return false;
  ...
  function is_builtin_pure_with_these_args(builtin, args) {
    ...
    if (lone_arg_is_range.has(builtin)) {
      const arg_valid = args.length > 1 || arg1 instanceof AST_Number && arg1.value >= 0 && arg1.value <= 4294967295;
      if (!arg_valid)
        return false;
    }
    if (arg1_is_range_or_iterable.has(builtin)) {
      const arg_valid = args.length === 0 || arg1 instanceof AST_Array || arg1 instanceof AST_Number && arg1.value >= 0 && arg1.value <= 4294967295;
      if (!arg_valid)
        return false;
    }
    if (arg1_is_iterable.has(builtin)) {
  ...
  // inst/bundle/node_modules/terser/lib/compress/inference.js
  ...
  AST_Call.DEFMETHOD("is_callee_pure", function(compressor) {
    if (compressor.option("unsafe")) {
      ...
      var first_arg;
      if (expr.expression && expr.expression.name === "hasOwnProperty" && ((first_arg = this.args && this.args[0] && this.args[0].evaluate(compressor)) == null || first_arg.thedef && first_arg.thedef.undeclared)) {
        return false;
      }
      if (is_undeclared_ref(expr) && global_pure_fns.has(expr.name))
        return true;
      if (is_pure_builtin_call(compressor, this))
        return true;
  ...
  // inst/bundle/node_modules/terser/lib/compress/evaluate.js
  ...
  def_eval(AST_Binary, function(compressor, depth) {
    ...
    if (typeof left === "bigint" !== (typeof right === "bigint") || typeof left === "bigint" && (this.operator === "/" && Number(right) === 0 || this.operator === ">>>" || this.operator === "**")) {
      return this;
    }
    var result;
    switch (this.operator) {
  ...
  def_eval(AST_PropAccess, function(compressor, depth, ast_chain) {
    let obj = (ast_chain || this.property === "length" || compressor.option("unsafe")) && this.expression._eval(compressor, depth + 1, ast_chain);
    if (ast_chain) {
  ...
  def_eval(AST_Call, function(compressor, depth, ast_chain) {
    ...
    if (compressor.option("unsafe") && exp instanceof AST_PropAccess) {
      ...
      if (is_undeclared_ref(e)) {
        ...
        if (!compressor.is_pure_native_static_fn(e.name, key))
          return this;
  ...
  // inst/bundle/node_modules/terser/lib/compress/drop-side-effect-free.js
  ...
  def_drop_side_effect_free(AST_DynamicImport, function(compressor, first_in_statement2) {
  ...
  def_drop_side_effect_free([
    ...
    return this.computed_key() ? this.key.drop_side_effect_free(compressor, first_in_statement2) : null;
  });
  def_drop_side_effect_free([
    AST_PrivateMethod,
    AST_PrivateGetter,
  ...
  // inst/bundle/node_modules/terser/lib/compress/drop-unused.js
  ...
  // inst/bundle/node_modules/terser/lib/compress/reduce-vars.js
  ...
  // inst/bundle/node_modules/terser/lib/compress/tighten-body.js
        ...
        if (is_func_expr(fn) && !fn.name && !fn.uses_arguments && !fn.pinned() && (iife = compressor2.parent()) instanceof AST_Call && iife.expression === fn && iife.args.every(arg_is_injectable)) {
          ...
          for (var i2 = len;--i2 >= 0; ) {
            ...
            if (sym instanceof AST_Expansion) {
              ...
              if (!arg) {
                arg = make_void_0(sym).transform(compressor2);
        ...
        return statements2[stat_index].transform(new TreeTransformer(function(node, descend, in_list) {
          ...
          if (node === expr || node.body === expr) {
            ...
            if (node instanceof AST_VarDef) {
              node.value = node.name instanceof AST_SymbolConst ? make_void_0(node.value) : null;
              return node;
            }
    ...
    function eliminate_dead_code(statements2, compressor2) {
      ...
      if (has_quit)
        has_quit.forEach(function(stat2) {
          extract_from_unreachable_code(compressor2, stat2, statements2);
        });
    }
      ...
      for (var i = 0;i < statements2.length; i++) {
        ...
        if (prev) {
          if (stat instanceof AST_Exit) {
            stat.value = cons_seq(stat.value || make_void_0(stat).transform(compressor2));
  ...
  // inst/bundle/node_modules/terser/lib/compress/inline.js
  ...
  function inline_into_call(self2, compressor) {
    ...
    if (can_inline && stat instanceof AST_Return) {
      ...
      if (fn.argnames.length === 1 && fn.argnames[0] instanceof AST_SymbolFunarg && self2.args.length < 2 && !(self2.args[0] instanceof AST_Expansion) && returned instanceof AST_SymbolRef && returned.name === fn.argnames[0].name) {
        const replacement = (self2.args[0] || make_void_0()).optimize(compressor);
        let parent;
    ...
    if (can_drop_this_call) {
      var args = self2.args.concat(make_void_0(self2));
  ...
  // inst/bundle/node_modules/terser/lib/compress/global-defs.js
  ...
  // inst/bundle/node_modules/terser/lib/compress/index.js
  ...
  AST_SymbolRef.DEFMETHOD("is_declared", function(compressor) {
    return !this.definition().undeclared || (compressor.option("unsafe") || compressor.option("builtins_pure")) && compressor.pure_access_globals(this.name);
  });
  ...
  AST_Scope.DEFMETHOD("hoist_properties", function(compressor) {
    ...
    var hoister = new TreeTransformer(function(node, descend) {
      if (node instanceof AST_VarDef) {
        ...
        let def;
        let value;
        if (sym.scope === self2 && !(sym instanceof AST_SymbolUsing) && (def = sym.definition()).escaped != 1 && !def.assignments && !def.direct_access && !def.single_use && !compressor.exposed(def) && !top_retain(def) && (value = sym.fixed_value()) === node.value && value instanceof AST_Object && !value.properties.some((prop) => prop instanceof AST_Expansion || prop.computed_key())) {
          descend(node, this);
          const defs = new Map;
          const assignments = [];
  ...
  function if_break_in_loop(self2, compressor) {
    ...
    if (compressor.option("dead_code") && is_break(first)) {
      ...
      extract_from_unreachable_code(compressor, self2.body, body);
  ...
  def_optimize(AST_If, function(self2, compressor) {
    ...
    if (compressor.option("dead_code")) {
      ...
      if (!cond) {
        ...
        if (self2.alternative) {
          extract_from_unreachable_code(compressor, self2.alternative, body);
        }
        return make_node(AST_BlockStatement, self2, { body }).optimize(compressor);
      }
    }
    ...
    if (self2.body instanceof AST_Exit && self2.alternative instanceof AST_Exit && self2.body.TYPE == self2.alternative.TYPE) {
      return make_node(self2.body.CTOR, self2, {
        value: make_node(AST_Conditional, self2, {
          condition: self2.condition,
          consequent: self2.body.value || make_void_0(self2.body),
          alternative: self2.alternative.value || make_void_0(self2.alternative)
        }).transform(compressor)
      }).optimize(compressor);
    }
  ...
  def_optimize(AST_Switch, function(self2, compressor) {
    ...
    }
    {
      ...
      for (;i2 >= 0; i2--) {
        ...
        while (is_break(bbody[bbody.length - 1], compressor))
          bbody.pop();
    ...
    function eliminate_branch(branch2, prev) {
      if (prev && !aborts(prev)) {
        ...
        extract_from_unreachable_code(compressor, branch2, decl);
      }
    }
  ...
  def_optimize(AST_Try, function(self2, compressor) {
    ...
    if (compressor.option("dead_code") && self2.body.body.every(is_empty)) {
      var body = [];
      if (self2.bcatch) {
        extract_from_unreachable_code(compressor, self2.bcatch, body);
      }
      if (self2.bfinally)
    ...
    if (exp instanceof AST_Dot && exp.expression instanceof AST_SymbolRef && exp.expression.name === "console" && exp.expression.definition().undeclared && exp.property === "assert") {
      ...
      if (condition) {
        ...
        if (value2 === 1 || value2 === true) {
          return make_void_0(self2).optimize(compressor);
        }
      }
    }
  ...
  def_optimize(AST_UnaryPrefix, function(self2, compressor) {
    ...
    if (self2.operator === "void" && e instanceof AST_Number && e.value === 0) {
      return unsafe_undefined_ref(self2, compressor) || self2;
    }
        ...
        case "!=":
          if (!is_strict_comparison && is_undefined(self2.left, compressor)) {
            ...
            if (expr instanceof AST_SymbolRef ? expr.is_declared(compressor) : !(expr instanceof AST_PropAccess && compressor.option("ie8"))) {
              self2.right = expr;
              self2.left = make_void_0(self2.left).optimize(compressor);
            ...
            if (expr instanceof AST_SymbolRef ? expr.is_declared(compressor) : !(expr instanceof AST_PropAccess && compressor.option("ie8"))) {
              self2.left = expr;
              self2.right = make_void_0(self2.right).optimize(compressor);
              if (self2.operator.length == 2)
                self2.operator += "=";
            }
  ...
  function unsafe_undefined_ref(self2, compressor) {
  ...
  def_optimize(AST_Undefined, function(self2, compressor) {
    var symbolref = unsafe_undefined_ref(self2, compressor);
    if (symbolref)
      return symbolref;
  ...
  // inst/bundle/node_modules/@jridgewell/sourcemap-codec/dist/sourcemap-codec.mjs
  var comma = 44;
  var semicolon = 59;
  ...
  // inst/bundle/node_modules/@jridgewell/trace-mapping/dist/trace-mapping.mjs
  ...
  // inst/bundle/node_modules/@jridgewell/gen-mapping/dist/gen-mapping.mjs
  var SetArray = class {
    constructor() {
  ...
  // inst/bundle/node_modules/@jridgewell/source-map/dist/source-map.mjs
  ...
  // inst/bundle/node_modules/terser/lib/sourcemap.js
  ...
  // inst/bundle/node_modules/terser/tools/domprops.js
  var domprops = [
    "$&",
    "$'",
    "$*",
  ...
  // inst/bundle/node_modules/terser/lib/propmangle.js
  ...
  // inst/bundle/node_modules/terser/lib/minify.js
...
//# sourceMappingURL=` + options.sourceMap.url;
    ...
    if (timings) {
      ...
      result.timings = {
        ...
        properties: 0.001 * (timings.format - timings.properties),
        format: 0.001 * (timings.end - timings.format),
